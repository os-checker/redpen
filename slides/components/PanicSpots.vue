<template>
  <div class="bg-gray-800 text-white p-4">
    ...
    <pre>
<span class="bold"><span class="f1"><span class="bold">error</span></span>: A possible panic spot is found.</span>
 <span class="bold"><span class="f4"><span class="bold">--&gt; </span></span></span>$DIR/2-method.rs:2:12
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>
<span class="bold"><span class="f4"><span class="bold">1</span></span></span> <span class="bold"><span class="f4"><span class="bold">|</span></span></span> pub fn panic() {
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span> <span class="bold"><span class="f4"><span class="bold">--------------</span></span></span> <span class="bold"><span class="f4"><span class="bold">For this function.</span></span></span>
<span class="bold"><span class="f4"><span class="bold">2</span></span></span> <span class="bold"><span class="f4"><span class="bold">|</span></span></span>     panic!(&quot;💥&quot;)
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>            <span class="bold"><span class="f1"><span class="bold">^^^^</span></span></span> <span class="bold"><span class="f1"><span class="bold">This may panic!</span></span></span>

<span class="bold"><span class="f1"><span class="bold">error</span></span>: A possible panic spot is found.</span>
 <span class="bold"><span class="f4"><span class="bold">--&gt; </span></span></span>$DIR/2-method.rs:8:9
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>
<span class="bold"><span class="f4"><span class="bold">7</span></span></span> <span class="bold"><span class="f4"><span class="bold">|</span></span></span> pub fn caller(&amp;self) {
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span> <span class="bold"><span class="f4"><span class="bold">--------------------</span></span></span> <span class="bold"><span class="f4"><span class="bold">For this function.</span></span></span>
<span class="bold"><span class="f4"><span class="bold">8</span></span></span> <span class="bold"><span class="f4"><span class="bold">|</span></span></span>         panic();
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>         <span class="bold"><span class="f1"><span class="bold">^^^^^^^</span></span></span> <span class="bold"><span class="f1"><span class="bold">This may panic!</span></span></span>
<span class="bold"><span class="f4"><span class="bold">9</span></span></span> <span class="bold"><span class="f4"><span class="bold">|</span></span></span>         panic!(&quot;Second panic.&quot;)
  <span class="bold"><span class="f4"><span class="bold">|</span></span></span>                <span class="bold"><span class="f1"><span class="bold">^^^^^^^^^^^^^^^</span></span></span> <span class="bold"><span class="f1"><span class="bold">This may panic!</span></span></span>
</pre>
